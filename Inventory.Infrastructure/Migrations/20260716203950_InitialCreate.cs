        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockBatches_PurchaseItems_PurchaseItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    StockBatchId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleItemAllocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleItemAllocations_SaleItems_SaleItemId",
                        column: x => x.SaleItemId,
                        principalTable: "SaleItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleItemAllocations_StockBatches_StockBatchId",
                        column: x => x.StockBatchId,
                        principalTable: "StockBatches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleItemAllocations_StockBatches_StockBatchId1",
                        column: x => x.StockBatchId1,
                        principalTable: "StockBatches",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleItemAllocations_SaleItemId",
                table: "SaleItemAllocations",
                column: "SaleItemId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleItemAllocations_StockBatchId",
                table: "SaleItemAllocations",
                column: "StockBatchId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleItemAllocations_StockBatchId1",
                table: "SaleItemAllocations",
                column: "StockBatchId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockBatches_PurchaseItemId",
                table: "StockBatches",
